            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="col">
                                ...
                                <div class="card-header"><h1 class="mb-1 text-primary">Kozee Insights</h1></div>
                                <div class="card-body">
                                ...
                                <br>        
                                <br>        
                                <h2 class="rating text-white"><b>Kozee Score: Locked</b></h2>
                                </div>
                                </div>
                                </div>
                                
                    <h2>Please login to view the insights.</h2> 
      <!-- /container -->
