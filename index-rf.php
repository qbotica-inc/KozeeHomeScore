                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                ...
                                <h2 class="pageheader-title">Street Address: <?php echo (string)$varStreet; ?>, Phoenix, AZ</h2>
                     ...
                     <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">House Score</h5>
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Walk Score:</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varWalkScore; ?></h1>
                                        </div><!--
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Transit Score:</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varTransitScore; ?></h1>
                                        </div><!--
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span><i class="fa fa-fw fa-arrow-up"></i></span><span>5.86%</span>
                                        </div>-->
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Bike Score:</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varBikeScore; ?></h1>
                                        </div><!--
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">No of Coffee shops</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varCoffee; ?></h1>
                                        </div><!--
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">No of restaurants</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varRestaurants; ?></h1>
                                        </div><!--
                                        <div class="metric-label d-inline-block float-right text-secondary font-weight-bold">
                                            <span>-2.00%</span>
                                        </div>-->
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Physical Condition:</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varPhyiscalCondition; ?></h1>
                                        </div><!--
                                        <div class="metric-label d-inline-block float-right text-secondary font-weight-bold">
                                            <span>-2.00%</span>
                                        </div>-->
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Heating Type</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varHeatingType; ?></h1>
                                        </div> <!--
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Heating System</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varHeatingSystem; ?></h1>
                                        </div> <!--
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span class="icon-circle-small icon-box-xs text-success bg-success-light"><i class="fa fa-fw fa-arrow-up"></i></span><span class="ml-1">5.86%</span>
                                        </div> -->
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Building Construction Quality</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varBuildingConstructionQuality; ?></h1>
                                        </div> <!--
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span class="icon-circle-small icon-box-xs text-success bg-success-light"><i class="fa fa-fw fa-arrow-up"></i></span><span class="ml-1">5.86%</span>
                                        </div> -->
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Exterior Wall</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varExteriorWall; ?></h1>
                                        </div> <!--
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Building Type</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varBuildingType; ?></h1>
                                        </div> <!--
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">No of Parking Spaces</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"><?php echo (string)$varNofParkingSpaces; ?></h1>
                                        </div> <!--
                                        <div class="metric-label d-inline-block float-right text-success font-weight-bold">
                                            <span class="icon-circle-small icon-box-xs text-success bg-success-light"><i class="fa fa-fw fa-arrow-up"></i></span><span class="ml-1">5%</span>
                                        </div> -->
                        ...
                        <!--    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="card border-3 border-top border-top-primary">
                                    <div class="card-body">
                                        <h5 class="text-muted">Cooling System</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1"></h1>
                                        </div><!--
