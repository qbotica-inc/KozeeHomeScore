...
<body>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Kozee Home page</h2>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA33mpxpbOnkD4hpWPsfUe20HtxTyYLL2M&libraries=places&callback=initAutocomplete"
         async defer></script>
                            </div>
...
<script>
                function check(){
                    samp = document.getElementById("pac-input").value;
                    //alert(samp);
                    localStorage.setItem("address", samp);
                    //window.location.href = "redfin.py";
                    //close();
                    //var_dump($output);
                    window.location.href = "index_login.php?" + samp;
                    
                }
                </script>                
                <a onclick="check()" class="button">View House Rating</a>
